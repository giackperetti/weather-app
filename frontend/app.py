...
class LoginPage(tk.Frame):
    ...
    def __init__(self, master) -> None:
        ...
        self.button = tk.Button(
            self, text="Invia", font=("cascadia Code", 15), cursor="hand2"
        )
